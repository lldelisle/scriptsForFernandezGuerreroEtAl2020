...
colStage <- c(rgb(227, 162, 8, maxColorValue=255), rgb(216, 127, 255, maxColorValue=255),
              rgb(28, 213, 112, maxColorValue=255), rgb(134, 195, 6, maxColorValue=255))
names(colStage)<-c("E9.5", "E10.5", "E11.5", "E12.5")
colReplicate<-c("mediumturquoise", "orchid")
names(colReplicate)<-c(1, 2)
anno_colors <- list(tissue=colTissue, stage=colStage, Replicate=colReplicate)
